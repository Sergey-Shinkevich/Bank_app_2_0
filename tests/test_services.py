...
def sample_data():
    ...
    return [
        {"Дата операции": "14.04.2026 10:00:00", "Категория": "Супермаркеты", "Сумма операции": -1000.0, "Валюта операции": "RUB"},
        {"Дата операции": "15.04.2026", "Категория": "Фастфуд", "Сумма операции": -350.0, "Валюта операции": "RUB"},
        {"Дата операции": "16.04.2026", "Категория": "Супермаркеты", "Сумма операции": -2000.0, "Валюта операции": "RUB"},
